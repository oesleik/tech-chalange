...
final class ConsultarOrdemServicoPorVeiculoEClienteRouter {
    public function __construct(private readonly ConsultarOrdemServicoPorVeiculoEClienteController $controller) {}
