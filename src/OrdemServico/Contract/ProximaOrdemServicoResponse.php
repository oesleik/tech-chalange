...
readonly class ProximaOrdemServicoResponse extends AbstractContract {
    ...
    public function __construct(
        ...
        #[OA\Property]
        public OrdemServicoCompletaResponse $ordem_servico,
     ...
     */
    public static function fromModel(OrdemServicoModel $model, array $pecas, array $servicos, AppConfig $appConfig): self {
        ...
        if ($model->getSituacao() == SituacaoOrdemServicoEnum::RECEBIDA) {
            return new self(
                ...
                ordem_servico: OrdemServicoCompletaResponse::fromModel($model, $pecas, $servicos),
                links: [
